...
// Removed TherapistNavbar import here, as it's now handled by App.jsx's AppNavbar
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#fefae0' }}>
      <Container maxWidth="lg" sx={{ py: 8 }}>
        ...
        {user.is_therapist && !user.is_verified ? (
          <Paper elevation={3} sx={{ p: 4, backgroundColor: 'white', borderRadius: 2, textAlign: 'center' }}>
            <Typography variant="h5" sx={{ color: '#780000', mb: 2, fontWeight: 'bold' }}>
              Therapist Application Status
            </Typography>
            <Typography variant="body1" sx={{ mb: 3 }}>
              Your application is currently **Pending Review** by our administration team.
              You will gain access to the full therapist dashboard once your application is approved.
            </Typography>
